...
#from nets.resnets import Adam_GCC2
...
if __name__ == "__main__":
    ...
    #   没有GPU可以设置成False
    # -------------------------------#
    #torch.distributed.init_process_group(backends='nccl')
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    #model_path = '/root/yanjun/faster-rcnn/logs/szh-ep100-loss1.227-val_loss1.541.pth'#/root/yanjun/faster-rcnn/model_data/resnet101-5d3b4d8f.pth'
    model_path = '/root/yanjun/faster-rcnn/model_data/resnet50-19c8e357.pth'
    # ------------------------------------------------------#
    #   输入的shape大小
    # ------------------------------------------------------#
    input_shape = [600, 600]
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = '2007_train1.txt'
    val_annotation_path = '2007_val1.txt'
    ...
    if Cuda: 
        #model_train = torch.nn.parallel.DistributedDataParallel(model)
    ...
    if True:
        ...
        optimizer = optimizer = optim.Adam(model_train.parameters(), lr, weight_decay=5e-4)
        lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=1, gamma=0.96)
        #lr_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer,T_max=10,eta_min=0,last_epoch=-1)
